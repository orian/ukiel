-- JSONBench — the 5-query Bluesky benchmark, ClickHouse variant (canonical form).
-- Source: https://github.com/ClickHouse/JSONBench (clickhouse/queries_formatted.sql), Apache-2.0.
-- Vendored VERBATIM. The executed file is queries.sql; this copy exists so every
-- adaptation is a reviewable diff, not a claim.
