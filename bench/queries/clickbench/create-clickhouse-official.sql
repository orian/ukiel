-- ClickBench, ClickHouse variant: the official 105-column table.
-- Source: https://github.com/ClickHouse/ClickBench (clickhouse/create.sql), Apache-2.0.
-- Vendored VERBATIM. This is the calibration fixture: it exists so our total can
-- be held against ClickHouse published ClickBench figure. Do not adapt it.
